...
// todo - replace all types with u1byte, u4byte, etc
	...
	void AES__EncryptBlock(const unsigned char * datain, unsigned char * dataout);
	...
	void AES__DecryptBlock(const unsigned char * datain, unsigned char * dataout);
